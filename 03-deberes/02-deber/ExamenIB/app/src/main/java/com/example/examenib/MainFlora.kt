...
class MainFlora : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val nombreParq = EBaseDeDatos.tablaEntrenador!!.obtenerParque(idParq)!!.nombre
        ...
        if (intent.hasExtra("baseFloraKey")) {
            ...
            if (baseFloraRecibido != null) {
                ...
                baseFloraRecibido.idParque?.let { EBaseDeDatos.tablaEntrenador!!.crearFlora(it,baseFloraRecibido.nombre, baseFloraRecibido.tipo, baseFloraRecibido.color, baseFloraRecibido.altura, baseFloraRecibido.enExtincion) }
                // val dat = gestorDatos.obtenerFloraPorIdParque(idParq)
                val dat = EBaseDeDatos.tablaEntrenador!!.getFloraPorIdParque(idParq)
        ...
        if (intent.hasExtra("baseParqueKeyEditar")) {
            ...
            if (baseFloraRecibido != null) {
                ...
                baseFloraRecibido.idParque?.let {
                    EBaseDeDatos.tablaEntrenador!!.actualizarFlora(baseFloraRecibido.idFlora,
                        it,baseFloraRecibido.nombre, baseFloraRecibido.tipo, baseFloraRecibido.color, baseFloraRecibido.altura, baseFloraRecibido.enExtincion)
                }
                idParq = baseFloraRecibido.idParque!!
                actualizarLista()
            }else{
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.menu_eliminar -> {
                ...
                val floraId = EBaseDeDatos.tablaEntrenador!!.getFloraPorIdParque(idParq)[posicionItemSeleccionado].idFlora

                // val nombre = gestorDatos.obtenerFloraPorIdParque(idParq)[posicionItemSeleccionado].nombre
                // gestorDatos.eliminarFlora(floraId)

                EBaseDeDatos.tablaEntrenador!!.eliminarFlora(floraId)
    ...
    private fun actualizarLista(): ListView {
        ...
        val arreglo = EBaseDeDatos.tablaEntrenador!!.getFloraPorIdParque(idParq)
        val listView = findViewById<ListView>(R.id.lv_main_flora)
