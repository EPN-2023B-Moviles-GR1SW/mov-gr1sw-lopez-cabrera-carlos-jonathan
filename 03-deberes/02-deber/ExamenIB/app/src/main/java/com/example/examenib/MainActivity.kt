    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("baseParqueKey")) {
            ...
            if (baseParqueRecibido != null) {
                ...
                EBaseDeDatos.tablaEntrenador!!.crearParque(baseParqueRecibido.nombre,baseParqueRecibido.extension,baseParqueRecibido.tipo,baseParqueRecibido.proteccion,baseParqueRecibido.accesibilidad)
        ...
        if (intent.hasExtra("baseParqueKeyEditar")) {
            ...
            if (baseParqueRecibidoEd != null) {
                ...
                baseParqueRecibidoEd.idParque?.let {
                    EBaseDeDatos.tablaEntrenador!!.actualizarParque(
                        it,baseParqueRecibidoEd.nombre,baseParqueRecibidoEd.extension,baseParqueRecibidoEd.tipo,baseParqueRecibidoEd.proteccion,baseParqueRecibidoEd.accesibilidad )
                }
            }else{
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.menu_ver -> {
                ...
                val ParqID = EBaseDeDatos.tablaEntrenador!!.getParques()[posicionItemSeleccionado].idParque
            ...
            R.id.menu_eliminar -> {
                ...
                val parqueId = EBaseDeDatos.tablaEntrenador!!.getParques()[posicionItemSeleccionado].idParque
                if (parqueId != null) {
                    // gestorDatos.eliminarParque(parqueId)
                    EBaseDeDatos.tablaEntrenador!!.eliminarParque(parqueId)
